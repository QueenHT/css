...
+ function($) {
  ...
  var Picker = function (params) {
      ...
      p.initPickerCol = function (colElement, updateItems) {
          ...
          col.calcSize = function () {
              ...
              minTranslate = colHeight / 2 - itemsHeight + itemHeight / 2 - 60;
              console.log(colHeight/ 2)
          ...
          col.wrapper.transform('translate3d(0,' + 60 + 'px,0)').transition(0);
  ...
  $.openPicker = function(tpl, className, callback) {
    ...
    var container = $("<div id='shinode' class='weui-picker-container "+ (className || "") + "'></div>").appendTo(document.body);
    container.show();
...
+ function($) {
  ...
  defaults = $.fn.select.prototype.defaults = {
    ...
    toolbarTemplate: '<div class="toolbar">\
      <div class="toolbar-inner">\
      <a id="confirm-city" href="javascript:;" class="picker-button close-select">{{closeText}}</a>\
      <h1 class="title">{{title}}</h1>\
      </div>\
      </div>',
    radioTemplate:
